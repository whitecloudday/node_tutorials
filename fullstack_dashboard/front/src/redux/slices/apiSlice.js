...
import { GET_VISITORS_API_URL, GET_REVENUE_API_URL, GET_CUSTOMERS_API_URL, GET_TARGETREALITY_API_URL, GET_TOP_PRODUCTS_API_URL, GET_SALES_MAP_API_URL, GET_VOLUME_SERVICES_API_URL } from "../../constants/apiUrls";
...
// GET Volume Services
export const fetchVolumeServices = createFetchThunk('fetchVolumeServices', GET_VOLUME_SERVICES_API_URL);
